        ...
        <div className="w-full  bg-[#1B1B1B] rounded-[20px]">
            ...
            <div className="flex items-center justify-between gap-[10px] w-full border border-[#404040] rounded-[10px] p-[15px] mb-[15px]">
                <div className="flex items-center gap-[13px] ">
                    <div className="flex w-full gap-[10px] items-center justify-center rounded-[5px] w-[38px] h-[38px] 
                    md:w-[40px] md:h-[40px] lg:w-[45px] lg:h-[45px] xl:w-[56px] xl:h-[56px] bg-[#302F2F]">

            ...
            {Loading ? (
              <LoadingSpinner />
                ...
                <tr key={index}>
                    ...
                    <td className="font-manrope font-[600] text-white text-[16px] text-left px-[10px] py-[16px]  border-b border-[#ffffff1a]  ">{moment(item?.created_at).format('DD-MMM-YYYY')}</td>
                    ...
                    <td className="font-manrope font-[600] text-white text-[16px] text-left px-[10px] py-[16px]  border-b border-[#ffffff1a]  ">{item?.eventname}</td>

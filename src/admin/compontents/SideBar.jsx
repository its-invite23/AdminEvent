...
function SideBar() {
    return (
        <div className="w-[100%] max-w-[286px] bg-[#1B1B1B] rounded-[20px] px-[15px] py-[20px] fixed z-[9] top-[15px] left-[15px] ">
            ...
            <div className="h-screen">
                ...
                <div className="absolute bottom-[40px] left-[35px]">
                    <Link to="/" className="flex items-center text-[15px] text-white">
                        <i className="text-white text-[20px] text-[#EB3465] pr-[8px]"><IoLogOutSharp /></i>
                        Log out
                    </Link>
                </div>
            </div>
